...
import com.kassmon.assembly.runTime.objects.commands.controlCommands.Nop;

public class NopParser extends Parser {
	...
	public ProgramLine Parse(Token command, Tokenizer tokenizer) throws ParserException, TokenizerExcption {
		if (command.getTokenData().equals("nop")) return new ProgramLine(new Nop());
