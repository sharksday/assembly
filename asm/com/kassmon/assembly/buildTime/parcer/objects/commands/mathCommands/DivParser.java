package com.kassmon.assembly.buildTime.parcer.objects.commands.mathCommands;
...
import com.kassmon.assembly.runTime.objects.commands.mathCommands.Div;

public class DivParser extends Parser {
	...
	public ProgramLine Parse(Token command, Tokenizer tokenizer) throws ParserException, TokenizerExcption {
		if (command.getTokenData().equals("div")) {
			...
			return new ProgramLine(new Div(getArgument(t)));
		}
