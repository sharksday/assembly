...
import com.kassmon.assembly.runTime.objects.commands.mathCommands.Xor;

public class XorParser extends Parser {
	...
	public ProgramLine Parse(Token command, Tokenizer tokenizer) throws ParserException, TokenizerExcption {
		if (command.getTokenData().equals("xor")) {
			...
			return new ProgramLine(new Xor(getArgument(t)));
		}
