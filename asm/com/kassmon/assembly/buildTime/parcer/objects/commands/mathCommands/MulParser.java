...
import com.kassmon.assembly.runTime.objects.commands.mathCommands.Mul;

public class MulParser extends Parser {
	...
	public ProgramLine Parse(Token command, Tokenizer tokenizer) throws ParserException, TokenizerExcption {
		if (command.getTokenData().equals("mul")) {
			...
			return new ProgramLine(new Mul(getArgument(t)));
		}
