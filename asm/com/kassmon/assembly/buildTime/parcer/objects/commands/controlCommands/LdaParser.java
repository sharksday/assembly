...
import com.kassmon.assembly.runTime.objects.commands.controlCommands.Lda;

public class LdaParser extends Parser {
	...
	public ProgramLine Parse(Token command, Tokenizer tokenizer) throws ParserException, TokenizerExcption {
		if (command.getTokenData().equals("lda")) {
			...
			return new ProgramLine(new Lda(getArgument(t)));
		}
