...
public class Or extends Command {
	...
	public Command parse(CommandTokenizer t) throws ParserException{
		...
		if (a1 == null) throw new ParserException("or : argument error : null arg");
		if (a2 == null) throw new ParserException("or : argument error : null arg");
		if (a3 == null) throw new ParserException("or : argument error : null arg");
		if (a1.isLabel()) throw new ParserException("or : argument error : illegal label");
		if (a2.isLabel()) throw new ParserException("or : argument error : illegal label");
		if (a3.isLabel()) throw new ParserException("or : argument error : illegal label");
		if (a3.isNumber()) throw new ParserException("or : argument error : illegal number");
