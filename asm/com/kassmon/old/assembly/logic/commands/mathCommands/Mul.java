...
public class Mul extends Command {
	...
	public Command parse(CommandTokenizer t) throws ParserException{
		...
		if (a1 == null) throw new ParserException("mul : argument error : null arg");
		if (a2 == null) throw new ParserException("mul : argument error : null arg");
		if (a3 == null) throw new ParserException("mul : argument error : null arg");
		if (a1.isLabel()) throw new ParserException("mul : argument error : illegal label");
		if (a2.isLabel()) throw new ParserException("mul : argument error : illegal label");
		if (a3.isLabel()) throw new ParserException("mul : argument error : illegal label");
		if (a3.isNumber()) throw new ParserException("mul : argument error : illegal number");
		return new Mul(a1, a2, a3);
	}
	...
	public Mul (Argument a1, Argument a2, Argument a3) {
		this.a1 = a1;
		this.a2 = a2;
		this.a3 = a3;
	}
