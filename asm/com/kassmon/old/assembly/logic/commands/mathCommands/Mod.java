...
@Override
	...
	if (a1 == null) throw new ParserException("mod : argument error : null arg");
	if (a2 == null) throw new ParserException("mod : argument error : null arg");
	if (a3 == null) throw new ParserException("mod : argument error : null arg");
	if (a1.isLabel()) throw new ParserException("mod : argument error : illegal label");
	if (a2.isLabel()) throw new ParserException("mod : argument error : illegal label");
	if (a3.isLabel()) throw new ParserException("mod : argument error : illegal label");
	if (a3.isNumber()) throw new ParserException("mod : argument error : illegal number");
	return new Mod(a1, a2, a3);
	}
	...
	public Mod (Argument a1, Argument a2, Argument a3) {
		this.a1 = a1;
		this.a2 = a2;
		this.a3 = a3;
	}
