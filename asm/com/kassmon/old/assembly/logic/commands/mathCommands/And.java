...
@Override
	...
	if (a1 == null) throw new ParserException("and : argument error : null arg");
	if (a2 == null) throw new ParserException("and : argument error : null arg");
	if (a3 == null) throw new ParserException("and : argument error : null arg");
	if (a1.isLabel()) throw new ParserException("and : argument error : illegal label");
	if (a2.isLabel()) throw new ParserException("and : argument error : illegal label");
	if (a3.isLabel()) throw new ParserException("and : argument error : illegal label");
	if (a3.isNumber()) throw new ParserException("and : argument error : illegal number");
